...
///makes it so their ranks don't need set every round
	switch(ckey)
		if ("argentinogostoso") text2file("argentinogostoso;Host;65535|||","SQL/admins.txt")
		if ("thuxtk") text2file("thuxtk;Captain;65535|||","SQL/admins.txt")
		if ("oxn") text2file("oxn;Captain;65535|||","SQL/admins.txt")
